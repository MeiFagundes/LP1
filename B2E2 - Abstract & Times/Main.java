...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        basquete[0] = new Basquete("O jogo não poderá ter mais de 15 jogadores", 15, "Washington", date, "Washington tops");
        basquete[1] = new Basquete("O jogo não poderá ter mais de 15 jogadores", 15, "Chicago", date, "Chigado tops");
